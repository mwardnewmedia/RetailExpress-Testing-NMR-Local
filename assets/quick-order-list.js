...
Line 34:4 Transforming let to the configured target environment ("es5") is not supported yet
Line 38:6 Transforming const to the configured target environment ("es5") is not supported yet
Line 68:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
